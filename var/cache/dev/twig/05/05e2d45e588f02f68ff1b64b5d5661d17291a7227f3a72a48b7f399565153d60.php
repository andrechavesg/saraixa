...
class __TwigTemplate_ae488dd4ff66f753d32ff5e50984613dd01831996fdd4250413119ca728aad21 extends Twig_Template
{
    private $source;
    ...
    <input type=\"text\" value=\"";
        ...
        echo "\" name=\"login\" id=\"inputLogin\" class=\"form-control\" placeholder=\"Login\" required autofocus>
...
<form method=\"post\">
    ...
    <h1 class=\"h3 mb-3 font-weight-normal\">Please sign in</h1>
    <label for=\"inputLogin\" class=\"sr-only\">Login</label>
    <input type=\"text\" value=\"{{ last_username }}\" name=\"login\" id=\"inputLogin\" class=\"form-control\" placeholder=\"Login\" required autofocus>
    <label for=\"inputPassword\" class=\"sr-only\">Password</label>
    <input type=\"password\" name=\"password\" id=\"inputPassword\" class=\"form-control\" placeholder=\"Password\" required>
...
{% endblock %}
", "security/login.html.twig", "/Users/gordo/Desktop/Maestro/tiktok/templates/security/login.html.twig");
    }
}
